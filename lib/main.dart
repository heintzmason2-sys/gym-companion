          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                final leanBulk = maintenance + 250;
                final recomp = maintenance;
                final cut = maintenance - 500;

                setState(() {
                  calculatorResult =
                      'BMI: ${bmi.toStringAsFixed(1)}\n'
                      '$category\n\n'
                      'Maintenance: ${maintenance.round()} kcal\n'
                      'Lean Bulk: ${leanBulk.round()} kcal\n'
                      'Recomp: ${recomp.round()} kcal\n'
                      'Cut: ${cut.round()} kcal';
                });
              },
